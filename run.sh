...
OPENBLAS_NUM_THREADS=1 python -u test_gs.py --dataset img100 --saved_path saved_models/mae.bt.rot.i100.vit.t.8.dist.pth --gpu 0 --model vit_t_8 --tsne --nw 4 --pf 2 --verbose

OPENBLAS_NUM_THREADS=1 python -u test_gs.py --dataset img100 --saved_path saved_models/mae.bt.rot.i100.vit.s.8.dist.pth --gpu 0 --model vit_s_8 --tsne --nw 4 --pf 2 --verbose
