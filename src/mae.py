...
class MAEDecoder(nn.Module):
    def __init__(self, embed_dim=1024, decoder_embed_dim=512, decoder_depth=8, 
                    decoder_num_heads=16, mlp_ratio=4., num_patches = 196, 
                    patch_size = 16, in_chans = 3, norm_layer=nn.LayerNorm):
        super().__init__()
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        self.base_encoder = MAEEncoder(img_size=img_size, patch_size=patch_size, in_chans=in_chans,
        ...
        num_patches = self.base_encoder.patch_embed.num_patches
        self.decoder = MAEDecoder(embed_dim=embed_dim, decoder_embed_dim=decoder_embed_dim, 
                                    ...
                                    mlp_ratio=mlp_ratio, norm_layer=norm_layer, num_patches = num_patches,
