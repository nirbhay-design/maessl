...
def train_maeclr(
    ...
    if device_id == eval_id:
        print(f"### mae + simclr Training begins")
    ...
    for epochs in range(n_epochs):
        ...
        for idx , (data, data_cap, _) in enumerate(train_loader):
            ...
            loss_con = output_combine["loss"] + weight * loss_clr
            ...
            if return_logs:
                progress(idx+1,len(train_loader), loss_clr=loss_clr.item(), loss_con=loss_con.item(), GPU = device_id)
